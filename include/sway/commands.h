...
sway_cmd cmd_fullscreen_on_request;
sway_cmd cmd_gaps;
...
sway_cmd cmd_scale_workspaces;
sway_cmd cmd_scratchpad;
sway_cmd cmd_scratchpad_minimize;
sway_cmd cmd_scratchpad_minimize_view;
...
sway_cmd cmd_snap_window_gap;
sway_cmd cmd_snap_workspace_gap;
sway_cmd cmd_snap_respect_gaps_inner;
...
sway_cmd animations_cmd_fade_in;
sway_cmd animations_cmd_fade_out;
